...
export default function QuizList() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-8 flex-grow w-full relative z-10">
      ...
      {/* Hero Welcome Banner */}
      <div className="glass-card rounded-3xl p-8 md:p-12 mb-10 border border-slate-200/50 dark:border-slate-800/50 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="relative z-10 max-w-xl text-center md:text-left">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-slate-800 dark:text-white leading-tight mb-4">
            Test Your Knowledge, <br/>
            <span className="bg-gradient-to-r from-primary-500 to-indigo-500 bg-clip-text text-transparent">
              Rule the Leaderboard!
            </span>
          </h1>
          <p className="text-slate-600 dark:text-slate-400 text-base max-w-lg mb-0 font-medium">
            Choose a category, toggle shufflers, solve under time limits, and publish your scores. Let's see if you can claim the Crown!
          </p>
        </div>
        <div className="relative w-40 h-40 md:w-48 md:h-48 flex items-center justify-center bg-gradient-to-tr from-primary-500 to-indigo-500 rounded-3xl rotate-12 shadow-xl shadow-primary-500/20">
      ...
      <div className="glass-card rounded-2xl p-5 mb-8 border border-slate-200/50 dark:border-slate-800/50 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400 mr-1 text-sm font-semibold">
          ...
          <select
            ...
            className="bg-slate-100/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2.5 outline-none text-xs font-semibold text-slate-700 dark:text-slate-300 focus:border-primary-500 cursor-pointer"
          >
            {categories.map((cat) => (
